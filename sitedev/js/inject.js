...
$(document).ready(function()
{
	...
	//$('head').prepend('<link rel="stylesheet" type="text/css" href="'+rootLocation+'css/reset.css" media="screen" /> ');        
